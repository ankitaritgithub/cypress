...
describe('Continuous Data Value for Digitized Businesses', () => {
  ...
  it('Validates each answer "content" of ask question along with validate the "drop-down" icons functionality of all these question ' , () => {
    ...
    cy.get('#accordion-item1 > p').should('be.visible')
        ...
        .and('have.css', 'text-align', 'start');
    cy.get(':nth-child(2) > .accordion-item-wrapper > .accordion-item-header > .accordion-arrow > .arrow-plus')
        .should('be.visible').scrollIntoView()
        .click();
    cy.get('.accordion-open > .accordion-item-wrapper > .accordion-item-header > .accordion-arrow').should('be.visible').scrollIntoView()
        ...
        // .and('have.css', 'text-align', 'start');
    // cy.get(':nth-child(3) > .accordion-item-wrapper > .accordion-item-header > .accordion-arrow > .arrow-plus')
    //     .should('be.visible')
    //     .click();
    ...
    //     .and('have.css', 'text-align', 'start');
    // cy.get(':nth-child(4) > .accordion-item-wrapper > .accordion-item-header > .accordion-arrow > .arrow-plus')
    //     .should('be.visible')
    //     .click();
    // cy.get('.accordion-open > .accordion-item-wrapper > .accordion-item-content > p').should('be.visible').scrollIntoView()
    ...
    //     .and('have.css', 'text-align', 'start');
    // cy.get(':nth-child(5) > .accordion-item-wrapper > .accordion-item-header > .accordion-arrow > .arrow-plus')
    //     .should('be.visible')
    //     .click();
    // cy.get(':nth-child(4) > .accordion-item-wrapper > .accordion-item-header > h3').should('be.visible').scrollIntoView()
    //     .and('contain.text', 'Key components of an IDP are app config, infra orchestration, environment management, deployment management, and role-based access control.')
